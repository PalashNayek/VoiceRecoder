...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val imgBtRecord: AppCompatImageButton?
    get() = findViewById(R.id.imgBtRecord)

    private val imgBtStop: AppCompatImageButton?
    get() = findViewById(R.id.imgBtStop)

    private val imgViewPlay: AppCompatImageView?
    get() = findViewById(R.id.imgViewPlay)

    private val imgBtRecordList: AppCompatImageButton?
    get() = findViewById(R.id.imgBtRecordList)

    private val llPlay: LinearLayoutCompat?
    get() = findViewById(R.id.llPlay)

    private val llRecorder: LinearLayout?
    get() = findViewById(R.id.llRecorder)
